...
import { Section, MonoLabel } from "@/components/section";
  ...
  return (
    <div className="min-h-screen bg-bg text-ink">
      <Masthead
        ...
        mode="public"
        tabs={[
          { label: "Mapa", href: "/dashboard", active: true },
      ...
      <div className="flex flex-col gap-6 px-8 pb-16 pt-7">
        ...
        <Section title="Filtros" hint="Combine para encontrar quem mora aqui e curte o quê.">
          <div className="grid gap-6 md:grid-cols-[1.3fr_1fr_0.7fr]">
            <div>
              <MonoLabel count={interestIds.length}>Interesse</MonoLabel>
              <InterestFilter interests={data.interests} selectedIds={interestIds} paramsString={paramsString} />
            </div>

            <div>
              <MonoLabel count={ageBands.length}>Faixa etária</MonoLabel>
            ...
            <div>
              <MonoLabel count={genders.length}>Gênero</MonoLabel>
              <div className="flex flex-wrap gap-1">
                {GENDERS.map((g) => (
                  <ChipFilter
                    key={g.value}
